...
//variables used to change the value wherever necessary
float i=0.0,m=0.0,n=0.0,o=0.0,c=0.0,b=0.0;  
float p=6.0,q=0.47,r=0.14; 

// variables used in light on/off inside the house
float e=0.90,f=0.91,g=0.98;
int count=0;

int light=1,day=1,plane=0,xm=900,bird=0;      
char ch;
...
// objects such as home,tree,sky,etc
void draw_object()
{
int l;
if(day==1)
...
if(light==0 && (i>=0 && i<=1150)) 
 {
	 ...
	 i+=SPEED/10;     //speed of bird
     m+=SPEED/150;       // speed of cloud
	n-=2;
	 o+=0.2;
	c+=2;
